package com.example.tugas4mobilea;
                ...
                result.addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity.this, "Pendaftaranberhasil. Silahkan login.", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(MainActivity.this, "Pendaftarangagal", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
